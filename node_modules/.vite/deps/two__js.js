...
var _Vector = class _Vector2 extends Events {
  constructor(x = 0, y = 0) {
    super();
...
var Constants = {
   ...
   */
  PublishDate: "2025-12-03T17:53:16.792Z",
  /**
   * @name Two.Identifier
...
var _Element = class _Element2 extends Events {
  constructor() {
    super();
   ...
   */
  static fromObject(obj) {
    const elem = new _Element2().copy(obj);
    if ("id" in obj) {
      elem.id = obj.id;
    }
    return elem;
...
var _Texture = class _Texture2 extends Element {
   ...
   */
  fromObject(obj) {
    const texture = new _Texture2().copy(obj);
    if ("id" in obj) {
      texture.id = obj.id;
    }
    return texture;
...
var _Stop = class _Stop2 extends Element {
   ...
   */
  static fromObject(obj) {
    const stop = new _Stop2().copy(obj);
    if ("id" in obj) {
      stop.id = obj.id;
    }
    return stop;
  ...
  copy(stop) {
    ...
    for (let i = 0; i < _Stop2.Properties.length; i++) {
      const k = _Stop2.Properties[i];
      if (k in stop) {
        this[k] = stop[k];
      }
    }
...
var _Gradient = class _Gradient2 extends Element {
  constructor(stops) {
    super();
  ...
  static fromObject(obj) {
    ...
    const gradient = new _Gradient2(stops).copy(obj);
    if ("id" in obj) {
      gradient.id = obj.id;
    }
    return gradient;
  ...
  copy(gradient) {
    ...
    for (let i = 0; i < _Gradient2.Properties.length; i++) {
      const k = _Gradient2.Properties[i];
      if (k in gradient) {
        this[k] = gradient[k];
      }
    }
...
var _LinearGradient = class _LinearGradient2 extends Gradient {
   ...
   */
  static fromObject(obj) {
    const gradient = new _LinearGradient2().copy(obj);
    if ("id" in obj) {
      gradient.id = obj.id;
    }
    return gradient;
  ...
  copy(gradient) {
    super.copy.call(this, gradient);
    for (let i = 0; i < _LinearGradient2.Properties.length; i++) {
      const k = _LinearGradient2.Properties[i];
      if (k in gradient) {
...
var _RadialGradient = class _RadialGradient2 extends Gradient {
   ...
   */
  static fromObject(obj) {
    const gradient = new _RadialGradient2().copy(obj);
    if ("id" in obj) {
      gradient.id = obj.id;
    }
    return gradient;
  ...
  copy(gradient) {
    super.copy.call(this, gradient);
    for (let i = 0; i < _RadialGradient2.Properties.length; i++) {
      const k = _RadialGradient2.Properties[i];
      if (k in gradient) {
  ...
  clone(parent) {
    ...
    _.each(
      Gradient.Properties.concat(_RadialGradient2.Properties),
      function(k) {
        clone[k] = this[k];
      },
      this
...
var tan = Math.tan;
var array = [];
var _Matrix = class _Matrix2 extends Events {
   ...
   */
  identity() {
    this.elements[0] = _Matrix2.Identity[0];
    this.elements[1] = _Matrix2.Identity[1];
    this.elements[2] = _Matrix2.Identity[2];
    this.elements[3] = _Matrix2.Identity[3];
    this.elements[4] = _Matrix2.Identity[4];
    this.elements[5] = _Matrix2.Identity[5];
    this.elements[6] = _Matrix2.Identity[6];
    this.elements[7] = _Matrix2.Identity[7];
    this.elements[8] = _Matrix2.Identity[8];
    return this.trigger(Events.Types.change);
  }
  /**
   * @name Two.Matrix#multiply
   ...
   */
  clone() {
    return new _Matrix2().copy(this);
  }
};
__publicField(_Matrix, "Identity", [1, 0, 0, 0, 1, 0, 0, 0, 1]);
var Matrix2 = _Matrix;
setMatrix(Matrix2);
var _Shape = class _Shape2 extends Element {
  constructor() {
    super();
   ...
   */
  static fromObject(obj) {
    const shape = new _Shape2().copy(obj);
    if ("id" in obj) {
      shape.id = obj.id;
    }
    return shape;
...
var _Path = class _Path2 extends Shape {
  ...
  static fromObject(obj) {
    ...
    const path = new _Path2().copy(__spreadProps(__spreadValues({}, obj), { fill, stroke }));
    if ("id" in obj) {
      path.id = obj.id;
    }
    return path;
...
var _Rectangle = class _Rectangle2 extends Path {
   ...
   */
  static fromObject(obj) {
    const rectangle = new _Rectangle2().copy(obj);
    if ("id" in obj) {
      rectangle.id = obj.id;
    }
    return rectangle;
  ...
  copy(rectangle) {
    ...
    for (let i = 0; i < _Rectangle2.Properties.length; i++) {
      const k = _Rectangle2.Properties[i];
      if (k in rectangle) {
   ...
   */
  clone(parent) {
    const clone = new _Rectangle2(0, 0, this.width, this.height);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var _Sprite = class _Sprite2 extends Rectangle {
   ...
   */
  static fromObject(obj) {
    const sprite = new _Sprite2().copy(obj);
    if ("id" in obj) {
      sprite.id = obj.id;
    }
    return sprite;
  ...
  copy(sprite) {
    ...
    for (let i = 0; i < _Sprite2.Properties.length; i++) {
      const k = _Sprite2.Properties[i];
      if (k in sprite) {
        this[k] = sprite[k];
      }
    }
...
var _ArcSegment = class _ArcSegment2 extends Path {
   ...
   */
  static fromObject(obj) {
    const segment = new _ArcSegment2().copy(obj);
    if ("id" in obj) {
      segment.id = obj.id;
    }
    return segment;
  ...
  copy(arcSegment) {
    ...
    for (let i = 0; i < _ArcSegment2.Properties.length; i++) {
      const k = _ArcSegment2.Properties[i];
  ...
  clone(parent) {
    ...
    const clone = new _ArcSegment2(0, 0, ir, or, sa, ea, resolution);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var cos2 = Math.cos;
var sin2 = Math.sin;
var _Circle = class _Circle2 extends Path {
   ...
   */
  static fromObject(obj) {
    const circle = new _Circle2().copy(obj);
    if ("id" in obj) {
      circle.id = obj.id;
    }
    return circle;
  ...
  copy(circle) {
    ...
    for (let i = 0; i < _Circle2.Properties.length; i++) {
      const k = _Circle2.Properties[i];
   ...
   */
  clone(parent) {
    const clone = new _Circle2(0, 0, this.radius, this.vertices.length);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var cos3 = Math.cos;
var sin3 = Math.sin;
var _Ellipse = class _Ellipse2 extends Path {
   ...
   */
  static fromObject(obj) {
    const ellipse = new _Ellipse2().copy(obj);
    if ("id" in obj) {
      ellipse.id = obj.id;
    }
    return ellipse;
  ...
  copy(ellipse) {
    ...
    for (let i = 0; i < _Ellipse2.Properties.length; i++) {
      const k = _Ellipse2.Properties[i];
  ...
  clone(parent) {
    ...
    const resolution = this.vertices.length;
    const clone = new _Ellipse2(0, 0, rx, ry, resolution);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var _Points = class _Points2 extends Shape {
  ...
  static fromObject(obj) {
    const fill = typeof obj.fill === "string" ? obj.fill : getEffectFromObject(obj.fill);
    const stroke = typeof obj.stroke === "string" ? obj.stroke : getEffectFromObject(obj.stroke);
    const points = new _Points2().copy(__spreadProps(__spreadValues({}, obj), { fill, stroke }));
    if ("id" in obj) {
      points.id = obj.id;
    }
    return points;
  ...
  copy(points) {
    ...
    for (let i = 0; i < _Points2.Properties.length; i++) {
      const k = _Points2.Properties[i];
      if (k in points) {
        this[k] = points[k];
      }
    }
...
var cos4 = Math.cos;
var sin4 = Math.sin;
var _Polygon = class _Polygon2 extends Path {
   ...
   */
  static fromObject(obj) {
    const polygon = new _Polygon2().copy(obj);
    if ("id" in obj) {
      polygon.id = obj.id;
    }
    return polygon;
  ...
  copy(polygon) {
    ...
    for (let i = 0; i < _Polygon2.Properties.length; i++) {
      const k = _Polygon2.Properties[i];
   ...
   */
  clone(parent) {
    const clone = new _Polygon2(0, 0, 0, this.sides);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var _RoundedRectangle = class _RoundedRectangle2 extends Path {
   ...
   */
  static fromObject(obj) {
    const rectangle = new _RoundedRectangle2().copy(obj);
    if ("id" in obj) {
      rectangle.id = obj.id;
    }
    return rectangle;
  ...
  copy(roundedRectangle) {
    ...
    for (let i = 0; i < _RoundedRectangle2.Properties.length; i++) {
      const k = _RoundedRectangle2.Properties[i];
  ...
  clone(parent) {
    ...
    const clone = new _RoundedRectangle2(0, 0, width, height, radius);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var cos5 = Math.cos;
var sin5 = Math.sin;
var _Star = class _Star2 extends Path {
   ...
   */
  static fromObject(obj) {
    const star = new _Star2().copy(obj);
    if ("id" in obj) {
      star.id = obj.id;
    }
    return star;
  ...
  copy(star) {
    ...
    for (let i = 0; i < _Star2.Properties.length; i++) {
      const k = _Star2.Properties[i];
  ...
  clone(parent) {
    ...
    const clone = new _Star2(0, 0, ir, or, sides);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    clone.skewX = this.skewX;
...
var _Text = class _Text2 extends Shape {
  constructor(message, x, y, styles) {
    ...
    for (let i = 0; i < _Text2.Properties.length; i++) {
      const property = _Text2.Properties[i];
  ...
  static Measure(text) {
    if (canvas) {
      ...
      const width = this.value.length * this.size * _Text2.Ratio;
  ...
  static fromObject(obj) {
    const fill = typeof obj.fill === "string" ? obj.fill : getEffectFromObject(obj.fill);
    const stroke = typeof obj.stroke === "string" ? obj.stroke : getEffectFromObject(obj.stroke);
    const text = new _Text2().copy(__spreadProps(__spreadValues({}, obj), { fill, stroke }));
    if ("id" in obj) {
      text.id = obj.id;
    }
    return text;
   ...
   */
  clone(parent) {
    const clone = new _Text2(this.value);
    clone.translation.copy(this.translation);
    clone.rotation = this.rotation;
    clone.scale = this.scale;
    for (let i = 0; i < _Text2.Properties.length; i++) {
      const prop = _Text2.Properties[i];
  ...
  getBoundingClientRect(shallow) {
    ...
    this._update(true);
    matrix = shallow ? this.matrix : this.worldMatrix;
    const { width, height } = _Text2.Measure(this);
...
var _ImageSequence = class _ImageSequence2 extends Rectangle {
  constructor(paths, ox, oy, frameRate) {
    ...
    if (typeof frameRate === "number") {
      ...
      this.frameRate = _ImageSequence2.DefaultFrameRate;
    }
    this.index = 0;
  }
  /**
   ...
   */
  static fromObject(obj) {
    const sequence = new _ImageSequence2().copy(obj);
    if ("id" in obj) {
      sequence.id = obj.id;
    }
    return sequence;
  ...
  copy(imageSequence) {
    ...
    for (let i = 0; i < _ImageSequence2.Properties.length; i++) {
      const k = _ImageSequence2.Properties[i];
   ...
   */
  clone(parent) {
    const clone = new _ImageSequence2(
      this.textures,
      this.translation.x,
      this.translation.y,
      this.frameRate
...
var _Group = class _Group2 extends Shape {
  constructor(children) {
    super();
  ...
  static fromObject(obj) {
    const group = new _Group2();
    for (let i = 0; i < _Group2.Properties.length; i++) {
      const k = _Group2.Properties[i];
      if (k in obj) {
    ...
    function getShapeFromObject(child) {
      if (child && child.renderer) {
        switch (child.renderer.type) {
          ...
          case "group":
            return _Group2.fromObject(child);
          case "image":
  ...
  static VisitForHitTest(group, context, includeGroups, filter, hitOptions, tolerance, stopOnFirst) {
    ...
    for (let i = children.length - 1; i >= 0; i--) {
      ...
      if (!_Group2.IsVisible(child, context.visibleOnly)) {
        continue;
      }
...
var _Image = class _Image2 extends Rectangle {
   ...
   */
  static fromObject(obj) {
    const image = new _Image2().copy(obj);
    if ("id" in obj) {
      image.id = obj.id;
    }
    return image;
  ...
  copy(image) {
    ...
    for (let i = 0; i < _Image2.Properties.length; i++) {
      const k = _Image2.Properties[i];
      if (k in image) {
        this[k] = image[k];
      }
    }
    ...
    if (effect) {
      ...
      if (effect.loaded) {
        ...
        switch (this._mode) {
          ...
          case _Image2.Modes.crop: {
            break;
          }
          case _Image2.Modes.tile: {
            effect.offset.x = (iw - rw) / 2;
            effect.offset.y = (ih - rh) / 2;
            effect.repeat = "repeat";
            break;
          }
          case _Image2.Modes.stretch:
          default: {
  ...
  constructor(options) {
    ...
    if (_.isElement(params.domElement)) {
      ...
      if (!/^(CanvasRenderer-canvas|WebGLRenderer-canvas|SVGRenderer-svg)$/.test(
        ...
        this.type = _Two2.Types[tagName];
      }
    }
    this.renderer = new _Two2[this.type](this);
...
//# sourceMappingURL=two__js.js.map
